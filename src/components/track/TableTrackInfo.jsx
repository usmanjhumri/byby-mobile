    ...
    return (
        <TableContainer component={Paper} sx={{ height: '400px', overflow: 'scrollY' }}>
            <Table aria-label="customized table">
                ...
                <TableBody>
                    <StyledTableRow key={fullName} sx={{ '&:hover': { boxShadow: '0px 1px 10px #1E1E1E', transition: '.5s', cursor: 'pointer' } }}>
                        <StyledTableCell>  1 </StyledTableCell>
                        <StyledTableCell >{fullName}</StyledTableCell>
                        <StyledTableCell align="center">{IMEI}</StyledTableCell>
                        <StyledTableCell align="center">{sellerFullName}</StyledTableCell>
                    </StyledTableRow>
                </TableBody>
            </Table>
        </TableContainer>
